class tree
{
	constructor(x,y)
	{
		...
		this.rightWallBody=Bodies.rectangle(this.x+this.treeWidth/2, this.y-this.dustbinHeight/2, this.wallThickness, this.dustbinHeight, {isStatic:false})
	...
	display()
	{
			...
			fill(255)
			imageMode(CENTER);
			image(this.image, 0,-this.dustbinHeight/2,this.treeWidth, this.dustbinHeight)
			pop()
